package com.wql.boot.wqlboot.controller.xxlsearch;
...
import com.wql.boot.wqlboot.service.xxlsearch.XxlSearchService;
import com.wql.boot.wqlboot.service.xxlsearch.model.ShopDTO;
...
@Controller
public class XxlSearchController {
	
    private static Logger logger = LogManager.getLogger(XxlSearchController.class.getName());

    @Resource
    private XxlSearchService luceneSearchServiceImpl;
    @Resource
    private XxlSearchService eSSearchServiceImpl;

    public XxlSearchService getXxlSearchService(){
        // type : ES、LUCENE
