package com.wql.boot.wqlboot.config.druid;
...
/**
 * sql监控的访问地址： http://127.0.0.1:8081/druid/index.html
 *
 * @author wangqiulin
 * @date 2018年5月12日
 */
...
public class DruidConfig {
    ...
    public ServletRegistrationBean druidStatViewServlet(){
        ...
        //登录查看信息的账号密码.
        servletRegistrationBean.addInitParameter("loginUsername","wql");
        servletRegistrationBean.addInitParameter("loginPassword","wql123");
        //是否能够重置数据.
