...
//import com.wql.boot.wqlboot.common.support.cat.method.CatMethodCache;
//import com.wql.boot.wqlboot.common.support.cat.method.CatMethodTransaction;
//
///**
// * 大众点评cat aop代理
// */
...
//     * 类级别的 transaction
//     */
//    @Around("execution(* com.wql.boot.wqlboot.service..*.*(..))")
...
//     * 拦截方法级别的
//     */
//    @Around("@annotation(com.wql.boot.wqlboot.common.support.cat.method.CatMethodTransaction)")
...
//     * 缓存测试
//     */
//    @Around("@annotation(com.wql.boot.wqlboot.common.support.cat.method.CatMethodCache)")
